...
<div class="max-w-2xl">
    <h1 class="heading-1 mb-8">Create Account</h1>
    <div class="form-card">
        <form action="{{ route('web.accounts.store') }}" method="POST" class="flex flex-col gap-6">
            @csrf
            ...
            <div class="form-group">
                ...
                <select name="type" id="type" required class="select @error('type') input-error @enderror">
