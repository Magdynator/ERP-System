...
<div class="max-w-2xl mt-8">
    <div class="mb-8 reveal">
        <h1 class="heading-1">Edit User</h1>
        <p class="text-sm text-gray-400 font-bold uppercase tracking-widest mt-1">Update Access Point Configuration</p>
    </div>

    <form action="{{ route('web.users.update', $user) }}" method="POST" class="form-card reveal">
        @csrf
        @method('PUT')
        ...
        <div class="form-group mb-6">
            <label for="password" class="form-label">Security Key (Leave blank to keep unchanged)</label>
