...
<div class="max-w-2xl">
    <h1 class="heading-1 mb-8">Create Category</h1>
    <div class="form-card">
        <form action="{{ route('web.categories.store') }}" method="POST" class="flex flex-col gap-6">
            @csrf
            ...
            <div class="form-group">
                ...
                <input id="slug" type="text" name="slug" value="{{ old('slug') }}" class="input" placeholder="auto-generated if empty">
